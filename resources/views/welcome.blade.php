...
@section('content')
    ...
    <div class="container marketing">
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <img class="img-circle" src="Images/tow_truck.png" alt="Generic placeholder image" width="230" height="230">
        ...
        <div class="col-lg-4">
          <img class="img-circle" src="Images/engine.png" alt="Generic placeholder image" width="230" height="230">
